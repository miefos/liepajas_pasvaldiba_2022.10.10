...
<!--            Ensure your account is using a long, random password to stay secure.-->
            Pārliecinies, ka jaunā parole ir droša, lai konts būtu drošībā.
        </template>

        <template #form>
            <div class="col-span-6 sm:col-span-4">
<!--                <jet-label for="current_password" value="Current Password" />-->
                <jet-label for="current_password" value="Pašreizējā parole" />
...
<!--                <jet-label for="password" value="New Password" />-->
                <jet-label for="password" value="Jaunā parole" />
...
<!--                <jet-label for="password_confirmation" value="Confirm Password" />-->
                <jet-label for="password_confirmation" value="Jaunās paroles apstiprinājums" />
