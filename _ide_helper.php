...
')
     ...
     */ 
        ...
        {
                        return \Illuminate\Http\RedirectResponse::danger($message);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function persistent($message)
        {
                        return \Illuminate\Http\RedirectResponse::persistent($message);
        }
